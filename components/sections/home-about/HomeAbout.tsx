...
export default function HomeAbout() {
  return (
    <section
      id="about"
      className="relative overflow-hidden bg-background py-15 lg:py-20"
    >
      {/* Background Effects */}
      <div className="absolute inset-0 -z-10 overflow-hidden">
        {/* Main Glow */}
        <div className="absolute left-1/2 top-1/2 h-[32rem] w-[32rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/10 blur-[160px]" />

        {/* Top Right Glow */}
        <div className="absolute right-0 top-0 h-72 w-72 rounded-full bg-accent/10 blur-[120px]" />
        ...
        <div
          className="
            absolute
            inset-0
            bg-[linear-gradient(rgba(23,53,46,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(23,53,46,0.05)_1px,transparent_1px)]
            bg-[size:60px_60px]
